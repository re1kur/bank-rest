...
public class CardsControllerTest {
    ...
    void readList__ReturnsPageDtoAndOk() throws Exception {
        ...
        when(service.readAll(PageRequest.of(page, size), filter)).thenReturn(new PageDto<>(List.of(CardDto.builder().userId(userId1).build(),
                CardDto.builder().userId(userId2).build()), 0, 5, 1, false, false));
        ...
        verify(service, times(1)).readAll(pageable, filter);
    }
}
